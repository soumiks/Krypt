...
export const __wbg_vendoraccesskey_free: (a: number, b: number) => void;
...
export const generate_vendor_key: (a: number, b: number, c: number, d: bigint) => [number, number, number];
export const masterkey_derive: (a: number) => [number, number, number];
export const vendoraccesskey_expires_at: (a: number) => bigint;
export const vendoraccesskey_from_components: (a: number, b: number, c: number, d: number, e: bigint) => [number, number, number];
export const vendoraccesskey_is_expired: (a: number, b: bigint) => number;
export const vendoraccesskey_key: (a: number) => [number, number];
export const vendoraccesskey_vendor_id: (a: number) => [number, number];
